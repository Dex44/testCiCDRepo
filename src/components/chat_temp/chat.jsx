...
const Chat = ({ token, chatRoom_v1 }) => {
  ...
  // }
  const statusChecker = () => {
    var interval = setInterval(doStuff, 1000); // 2000 ms = start after 2sec
    function doStuff() {
  ...
  //       tokenProvider: () =>
  //         tokenProvider("User123344", ['SEND_MESSAGE', 'DELETE_MESSAGE', 'DISCONNECT_USER'], "avatarUrl"),
  //     });
  //     console.log("room")
  //     setChatRoom(room);
            ...
            <div className="chat-wrapper">
              ...
              <div className="composer fl fl-j-center">
                <input
                  ...
                  type="text"
                  placeholder={
                    token ? "Say something" : "Waiting to connect..."
                  }
                  value={message}
                  maxLength={500}
                  disabled={!token}
